...
void LED_Func()
{
	if(gpio_output_bit_get(GPIOC, GPIO_PIN_13)!=RESET)
	{
...
#	endif
	...
	do
	{
		...
		Lcd_Draw_UTF8_String(0,0,(uint8_t*)"Fonts 中文\n8x16\n16x16");
	...
	do
	{
	  ...
	  Lcd_Set_Driver_Mode(write_inverse);//反写模式(普通)
		Lcd_Draw_UTF8_String(10,1,(uint8_t*)"Fill_RBox_ABCDEFGHIJK");
...
#	endif
	...
	do
	{
		...
		Lcd_Draw_UTF8_String(0,0,(uint8_t*)"1/3 Fonts 中文\n8x16\n16x16");
	}while(LCD_Refresh());//直到每行都刷完
	delay_ms(DEMO_DELAY_MS);
	do
	{
		...
		Lcd_Draw_UTF8_String(0,0,(uint8_t*)"2/3 Fonts 中文\n8x16\n16x16");
	}while(LCD_Refresh());//直到每行都刷完
	delay_ms(DEMO_DELAY_MS);
	do
	{
		...
		Lcd_Draw_UTF8_String(0,0,(uint8_t*)"3/3 Fonts 中文\n8x16\n16x16");
	}while(LCD_Refresh());//直到每行都刷完
	delay_ms(DEMO_DELAY_MS);
	...
	do
	{
		...
		Lcd_Draw_UTF8_String(0,0,(uint8_t*)"1/3 Fonts 中文\n6x12\12x12");
		Lcd_Set_Driver_Mode(write_2);//笔刷颜色设为LCD_COLOUR_2
		Lcd_Draw_UTF8_String(4,4,(uint8_t*)"2/3 Fonts 中文\n6x12\12x12");
	}while(LCD_Refresh());//直到每行都刷完
	delay_ms(DEMO_DELAY_MS);
	...
	do
	{
		...
		Lcd_Draw_UTF8_String(8,8,(uint8_t*)"3/3 Fonts 中文\n6x12\12x12");
	}while(LCD_Refresh());//直到每行都刷完
	delay_ms(DEMO_DELAY_MS);
	...
	do
	{
		...
		Lcd_Draw_UTF8_String(8,8,(uint8_t*)"3/3 Fonts 中文\n6x12\12x12");
		Lcd_Set_Driver_Mode(write_1);//笔刷颜色设为LCD_COLOUR_1
		Lcd_Draw_UTF8_String(12,12,(uint8_t*)"1/3 Fonts 中文\n6x12\12x12");
	}while(LCD_Refresh());//直到每行都刷完
	delay_ms(DEMO_DELAY_MS);
	...
	do
	{
		...
		Lcd_Draw_UTF8_String(12,12,(uint8_t*)"1/3 Fonts 中文\n6x12\12x12");
		Lcd_Set_Driver_Mode(write_1);//笔刷颜色设为LCD_COLOUR_1
		Lcd_Draw_UTF8_String(16,16,(uint8_t*)"2/3 Fonts 中文\n6x12\12x12");
	}while(LCD_Refresh());//直到每行都刷完
	delay_ms(DEMO_DELAY_MS);
	delay_ms(DEMO_DELAY_MS);
	delay_ms(DEMO_DELAY_MS);
...
#	endif
	...
	do
	{
		...
		Lcd_Draw_UTF8_String(10,8,(uint8_t*)"COLOUR 0/3");
	}while(LCD_Refresh());//直到每行都刷完
	delay_ms(DEMO_DELAY_MS);
	...
	do
	{
		...
		//2.-----绘图-----
		Lcd_Set_Driver_Mode(write_inverse);//笔刷颜色设为反色
		Lcd_Draw_UTF8_String(10,8,(uint8_t*)"COLOUR 1/3");
	}while(LCD_Refresh());//直到每行都刷完
	delay_ms(DEMO_DELAY_MS);
		...
		do
	{
		...
		//2.-----绘图-----
		Lcd_Set_Driver_Mode(write_inverse);//笔刷颜色设为反色
		Lcd_Draw_UTF8_String(10,8,(uint8_t*)"COLOUR 2/3");
	}while(LCD_Refresh());//直到每行都刷完
	delay_ms(DEMO_DELAY_MS);
	...
	do
	{
		...
		//2.-----绘图-----
		Lcd_Set_Driver_Mode(write_inverse);//笔刷颜色设为反色
		Lcd_Draw_UTF8_String(10,8,(uint8_t*)"COLOUR 3/3");
	}while(LCD_Refresh());//直到每行都刷完
	delay_ms(DEMO_DELAY_MS);
