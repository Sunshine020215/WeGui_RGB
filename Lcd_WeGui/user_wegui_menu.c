...
menu_t m_wDemo =
{
	...
	.discribe=              
	{                       
		.str_zh_CN=(uint8_t *)"1.控件Demo",//中文描述
	  .str_en_US=(uint8_t *)"1.Widget demo",//英文描述
	},
	.menuType=mList,//菜单类型
	.menuPar.mList_Par =
	{
...
void m_App_ThemeClock_Refresh(void);//刷新屏幕时执行,放绘图函数
...
menu_t m_App_Setting =
{
	...
	.discribe=
	{
		.str_zh_CN=(uint8_t *)"4.设置",//中文描述
	  .str_en_US=(uint8_t *)"4.Setting",//英文描述
	},
	.menuType=mList,//菜单类型
	.menuPar.mList_Par =
	{
...
menu_t m_App_5 =
{
	...
	.titel=
	{
		.str_zh_CN=(uint8_t *)"应用5",//中文标题
	  .str_en_US=(uint8_t *)"APP 5",//英文标题
	},                      
	.discribe=              
	{                       
...
menu_t m_App_6 =
{
	...
	.titel=
	{
		.str_zh_CN=(uint8_t *)"应用6",//中文标题
	  .str_en_US=(uint8_t *)"APP 6",//英文标题
	},                      
	.discribe=              
	{                       
		.str_zh_CN=(uint8_t *)"6.应用6",//中文描述
	  .str_en_US=(uint8_t *)"6.App 6",//英文描述
	},
	.menuType=mList,//菜单类型
	.menuPar.mList_Par =
	{
...
menu_t m_App_7 =
{
	...
	.titel=
	{
		.str_zh_CN=(uint8_t *)"应用7",//中文标题
	  .str_en_US=(uint8_t *)"APP 7",//英文标题
	},                      
	.discribe=              
	{                       
		.str_zh_CN=(uint8_t *)"7.应用7",//中文描述
	  .str_en_US=(uint8_t *)"7.App 7",//英文描述
	},
	.menuType=mList,//菜单类型
	.menuPar.mList_Par =
	{
...
menu_t m_Setting_Developer_wDebugInfoEn=
{
	...
	.titel=
	{
		.str_zh_CN=(uint8_t *)" ",//中文标题 控件可不设置标题
	  .str_en_US=(uint8_t *)" ",//英文标题 控件可不设置标题
	},
	.discribe=
	{
		.str_zh_CN=(uint8_t *)"1.调试窗口",//中文描述
	  .str_en_US=(uint8_t *)"1.Debug Windows",//英文描述
	},
	.menuType=wCheckBox,//菜单类型
	.menuPar.wCheckBox_Par =
	{
...
menu_t m_Setting_About_wCpu=
{
	...
	.discribe=
	{
		.str_zh_CN=(uint8_t *)"主控",//中文描述
	  .str_en_US=(uint8_t *)"MCU",//英文描述
	},
	.menuType=wMessage,//菜单类型
	.menuPar.wMessage_Par.Value_string = (uint8_t *)"STM32F1",
	.menuPar.wMessage_Par.Tip_string=
	{
		.str_zh_CN=(uint8_t *)"STM32F103C8T6",//中文标题
	  .str_en_US=(uint8_t *)"STM32F103C8T6",//英文标题
	},
};
...
menu_t m_Setting_About_wSoft=
{
	...
	.discribe=
	{
		.str_zh_CN=(uint8_t *)"Software",//中文描述
	  .str_en_US=(uint8_t *)"Software",//英文描述
	},
	.menuType=wMessage,//菜单类型
